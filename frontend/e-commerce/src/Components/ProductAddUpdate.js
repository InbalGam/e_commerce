...
function ProductAddUpdate(props) {
    ...
    return (
        <form className="productForm">
            ...
            <input id='quantity' type='number' name='quantity' value={quantity} placeholder={'Enter quantity'} onChange={handleQuantityChange} className='formParams'/>
            <label htmlFor="price">Price</label>
            <input id='price' type='number' name='price' value={price} placeholder={'Enter price'} onChange={handlePriceChange} className='formParams'/>
            <label htmlFor="discount">Discount</label>
            <input id='discount' type='number' name='discount' value={discount} placeholder={'Enter discount if relevant'} onChange={handleDiscountChange} className='formParams'/>
